...
[![npm](https://img.shields.io/npm/v/@lcv-ideas-software/cross-review-mcp.svg)](https://www.npmjs.com/package/@lcv-ideas-software/cross-review-mcp)
...
```bash
git clone https://github.com/LCV-Ideas-Software/cross-review-mcp.git
cd cross-review-mcp
npm install
```
